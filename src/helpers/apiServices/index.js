...
class apiServices {
    ...
    sendMessages(messageObj, reference) {
    	return new Promise((resolve, reject) => {
	        try {
				...
				xhr.send(JSON.stringify({ "phone": reference , "message": messageObj.message, "messageId": messageObj.ReferenceMessageId }));
	...
	sendImagem(image, reference, messageObj) {
		return new Promise((resolve, reject) => {
	        try {
	     		var xhr = new XMLHttpRequest();
				...
				xhr.send(JSON.stringify({ "phone": reference , "image": image.url, "caption": messageObj.message, "messageId": messageObj.ReferenceMessageId }));
				xhr.onreadystatechange = function() {
	    			if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
		    			axios.get("https://api.z-api.io/instances/38D8CC84406F2021E634BE6CF1A401E6/token/5472C5514B387077FE149946/queue")
						.then(function (response) {
	...
	sendAudio(audio, reference, messageObj) {
		return new Promise((resolve, reject) => {
	        try {
	     		var xhr = new XMLHttpRequest();
				...
				xhr.send(JSON.stringify({ "phone": reference , "audio": audio.url, "messageId": messageObj.ReferenceMessageId }));
				xhr.onreadystatechange = function() {
	    			if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
		    			axios.get("https://api.z-api.io/instances/38D8CC84406F2021E634BE6CF1A401E6/token/5472C5514B387077FE149946/queue")
						.then(function (response) {
	...
	sendDocument(documento, reference, messageObj) {
		return new Promise((resolve, reject) => {
	        try {
	     		var xhr = new XMLHttpRequest();
				...
				xhr.send(JSON.stringify({ "phone": reference , "document": documento.url, "fileName":messageObj.fileMessage, "messageId": messageObj.ReferenceMessageId }));
				xhr.onreadystatechange = function() {
	    			if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
		    			axios.get("https://api.z-api.io/instances/38D8CC84406F2021E634BE6CF1A401E6/token/5472C5514B387077FE149946/queue")
						.then(function (response) {
